  ...
  $.fn.extend({
    slimScroll: function (options) {
      ...
      this.each(function () {
        ...
        // set position
        var posCss = (o.position == 'right') ? {right: 0} : {left: 0};
        rail.css(posCss);
        bar.css(posCss);
        ...
        function attachWheel()
        {
          ...
          { 
            this.addEventListener('DOMMouseScroll', _onWheel, true);
            this.addEventListener('mousewheel', _onWheel, true);
          }
          else
          {
        ...
        function showBar()
        {
          ...
          bar.stop(true, true).fadeIn('slow');
          if (o.railVisible) {
            rail.stop(true, true).fadeIn('slow');
          }
        }
